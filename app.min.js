...
for (const [index, universe] of __WEBPACK_IMPORTED_MODULE_0__config_js__["a" /* default */].entries()) {
  const universeEl = __WEBPACK_IMPORTED_MODULE_1_domify___default()(`<li class="universe" title="${universe.name}"></li>`)
  const rotation = (360 / __WEBPACK_IMPORTED_MODULE_0__config_js__["a" /* default */].length * index) - 90
